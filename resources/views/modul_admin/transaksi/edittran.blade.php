            ...
            <form action="{{route('transaksi.update', $edit->id)}}" method="POST">
                ...
                <div class="form-body">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-12">
                        <div class="form-group">
                            <label for="no-telp-cabang">Status transaksi</label>
                            <div class="position-relative">
                    ...
                    <div class="col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                            <label for="alamat-transaksi">Alamat transaksi</label>
                            <div class="position-relative">
                                <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat-transaksi" rows="3" disabled> {{$edit->alamat}} </textarea>
                                @error('alamat')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
