            ...
            <div class="row m-0">
                ...
                <div class="col-lg-6 col-12 p-0">
                    <div class="card rounded-0 mb-0 px-2">
                        ...
                        <p class="px-2">Selamat Datang DI HARUM LAUNDRY , Masuk Menggunakan Akun Kamu.</p>
                        ...
                        <div class="login-footer">
                            <div class="divider">
                                <div class="divider-text"><a href="/">NONAS LAUNDRY</a></div>
                            </div>
                            <p style="font-size:10px">Jika ingin mendaftar silahkan hubungi : harumlaundry@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
